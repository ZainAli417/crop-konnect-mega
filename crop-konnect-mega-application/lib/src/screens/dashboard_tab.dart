...
class DashboardTab extends StatelessWidget {
  ...
  /// Returns to the Home tab (farm list). Null hides the back action.
  final VoidCallback? onBack;

  /// The farm being detailed. Defaults to the controller's farm.
  final Farm? farm;
              ...
              children: [
                ...
                _SectionReveal(
                  ...
                  child: _StatusBanner(
                    ...
                    onBack: onBack,
                    farmName: (farm ?? controller.farm).name,
                  ),
                ),
...
class _StatusBanner extends StatelessWidget {
  ...
  /// Farm this dashboard details — shown as the headline when provided.
  ...
  Widget build(BuildContext context) {
    ...
    final title = (farmName != null && farmName!.isNotEmpty)
        ? farmName!
        : stationName;
                ...
                children: [
                  ...
                  wide
                      ? Row(
                          ...
                          children: [
                            _StationNameBlock(
                                name: title, subtitle: stationName),
                            const Spacer(),
                            _StatusBlock(
...
class _StationNameBlock extends StatelessWidget {
  const _StationNameBlock({required this.name, this.subtitle});
  final String name;

  /// Logger / station feeding this dashboard. Falls back to the generic strap
  /// line when absent.
